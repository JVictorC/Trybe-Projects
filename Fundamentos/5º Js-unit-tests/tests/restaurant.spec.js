...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual(menu.fetchMenu(), { food: { 'coxinha': 3.9, 'sopa': 9.9 }, drink: { 'agua': 3.9, 'cerveja': 6.9 } })
    ...
    const keys = () => {
      let teste = createMenu({ food: {}, drink: {} }).fetchMenu();
      return teste;
    };
    ...
    assert.deepStrictEqual(menu.fetchMenu(), objetoRetornado)
    ...
    assert.deepStrictEqual(menu.order('coxinha'), menu.consumption['coxinha'])
    menu.consumption = [];
    ...
    assert.deepStrictEqual(testOrder(), ["coxinha", "agua", "sopa", "sashimi"])
    ...
    assert.deepStrictEqual(ordersTest2(), ['coxinha', 'agua', 'coxinha'])
    ...
    assert.strictEqual(ordersTest3(), 11.7)
